...
process.analyzeHiMassTau.bTagger = cms.untracked.string('trackCountingHighEffBJetTagsPF')			# name of the b-Tagger
process.analyzeHiMassTau.JetBTaggingCut                  = cms.double(3.3)                              # tagged as b-jet if TCHE > X
