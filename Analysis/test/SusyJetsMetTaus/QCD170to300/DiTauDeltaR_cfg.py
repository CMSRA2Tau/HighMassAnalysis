...
process.analyzeHiMassTau = cms.EDAnalyzer('HiMassTauAnalysis',
    ...
    #-----Reco Tau Inputs
    RecoTauSource = cms.InputTag('selectedLayer1ShrinkingConeHighEffPFTaus'),		# choices include:
    ...
    RecoSecondLeadingJetPt		= cms.double(50.0),
    ...
    #-----Trigger Inputs
    RecoTriggerSource = cms.InputTag("TriggerResults","","REDIGI38X"),			# trigger collection
