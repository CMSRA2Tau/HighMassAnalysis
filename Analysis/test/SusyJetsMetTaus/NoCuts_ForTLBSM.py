...
'file:/uscms/home/meloam/susy/ttbsmsusyv1/OLDSUSY2/src/TopQuarkAnalysis/TopPairBSM/test/ttbsm_52x_mc.root'
)
)
...
process.analyzeHiMassTau.GenParticleSource = cms.untracked.InputTag('')				# gen particle collection
...
process.analyzeHiMassTau.M12 = cms.double(360.)
    ...
    #-----Reco Tau Inputs
process.analyzeHiMassTau.RecoTauSource = cms.InputTag('selectedPatTausPFlow')
...
process.analyzeHiMassTau.RecoElectronSource = cms.InputTag('selectedPatElectrons')			        
...
#    process.analyzeHiMassTau.DoRecoElectron2DiscrByTrackerDrivenSeed = cms.bool(False)
    ...
    #-----Reco Jet Inputs
process.analyzeHiMassTau.RecoJetSource                       = cms.InputTag('goodPatJetsPFlow')              
...
process.analyzeHiMassTau.JetBTaggingCut                  = cms.double(0.679)
    ...
    #-----Vertex Inputs
process.analyzeHiMassTau.RecoVertexSource = cms.InputTag('goodOfflinePrimaryVertices') 				# vertex collection
...
process.analyzeHiMassTau.Dphi2MaxCut = cms.double(9999.5)                                               
    ...
    #-----Topology Inputs
process.analyzeHiMassTau.RecoMetSource = cms.InputTag('patMETsPFlow')		
