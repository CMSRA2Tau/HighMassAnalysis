...
process.analyzeHiMassTau.M0 = cms.double(320.)
process.analyzeHiMassTau.M12 = cms.double(440.)

    #-----Reco Tau Inputs
process.analyzeHiMassTau.RecoTauSource = cms.InputTag('selectedLayer1HPSPFTaus')
...
process.analyzeHiMassTau.RecoTau1DiscrByIsolation = cms.untracked.string('byVLooseIsolation')	
...
process.analyzeHiMassTau.RecoTau1DiscrAgainstElectron = cms.untracked.string('againstTightElectron')
...
process.analyzeHiMassTau.RecoTau1DiscrAgainstMuon = cms.untracked.string('againstTightMuon')
...
process.analyzeHiMassTau.DoRecoElectron1DiscrByTrackIsolation = cms.bool(True) 				
...
process.analyzeHiMassTau.DoRecoElectron1DiscrByEcalIsolation = cms.bool(True) 				
...
process.analyzeHiMassTau.DoRecoElectron1DiscrBySCE2by5Over5by5 = cms.bool(True)			
...
process.analyzeHiMassTau.DoRecoElectron2DiscrByTrackIsolation = cms.bool(True)
...
process.analyzeHiMassTau.DoRecoElectron2DiscrByEcalIsolation = cms.bool(True)
...
process.analyzeHiMassTau.DoRecoElectron2DiscrBySCE2by5Over5by5 = cms.bool(True)
...
#    process.analyzeHiMassTau.DoRecoElectron2DiscrByTrackerDrivenSeed = cms.bool(False)
    ...
    #-----Reco Jet Inputs
process.analyzeHiMassTau.RecoJetSource                       = cms.InputTag('patJetsPF')              
...
process.analyzeHiMassTau.Dphi2MinCut = cms.double(0.0)                                                     
process.analyzeHiMassTau.Dphi2MaxCut = cms.double(0.1)                                               

    #-----Topology Inputs
process.analyzeHiMassTau.RecoMetSource = cms.InputTag('patMETsPFL1L2L3Cor')		
...
process.analyzeHiMassTau.Muon1MetMtMinCut = cms.double(50.0)
process.analyzeHiMassTau.Muon1MetMtMaxCut = cms.double(100.0)
...
process.analyzeHiMassTau.RecoTau2Nmin = cms.int32(1)							
...
process.analyzeHiMassTau.EventSelectionSequence = cms.vstring('RecoTriggersNmin','RecoVertexNmin','RecoVertexNmax',
