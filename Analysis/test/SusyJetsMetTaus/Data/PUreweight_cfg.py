...
#'/store/user/gurrola/gurrola/TTJets_TuneZ2_7TeV-madgraph-tauola/Ttbar424TauTauSkimPat/75448fb324d0d74d73f257a7dc924fbf/skimPat_1_1_UHF.root',
#'/store/user/gurrola/gurrola/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola/Wjets424TauTauSkimPat/75448fb324d0d74d73f257a7dc924fbf/skimPat_1_1_E5T.root',
'/store/user/grace/QCD_Pt-1400to1800_TuneZ2_7TeV_pythia6/DiTauSkim/75448fb324d0d74d73f257a7dc924fbf/skimPat_1_1_brG.root',
...
process.analyzeHiMassTau = cms.EDAnalyzer('HiMassTauAnalysis',
    ...
    DoRecoTauDiscrAgainstElectron = cms.bool(False),					# if true, default tau POG electron
    ...
    #***Always False for Data***
    # For MC, you must first run on both data and MC without reweighting
    # These two output files become the two input files below and you can THEN run with DoPUrewieghting = cms.bool(True),
    DoPUrewieghting = cms.bool(True),
    DataHistos = cms.string("Data.root"),
    MCHistos = cms.string("MC.root"),
...
#   This cut does Dphi(Jet(1,2),MHT)<(X,X)
#   Currently used to extract QCD control sample
    DoSUSYDiscrByDphiMhtJet = cms.bool(True),
    DphiMhtJet1 = cms.double(0.5),
    DphiMhtJet2 = cms.double(0.5),
