...
#    DoRecoElectronDiscrByTrackerDrivenSeed = cms.bool(False),				# if true, require electron to be tracker driven
    ...
    RemoveBJetOverlapWithTaus            = cms.bool(False),                               # if true, jets w/ dR(tau,jet)<X will not be considered
    ...
    RecoBJetNmin = cms.int32(2),							# require event to have >=X "jets" passing specified cuts
