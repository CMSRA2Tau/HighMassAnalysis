...
process.analyzeHiMassTau.RemoveSecondLeadingJetOverlapWithTaus            = cms.bool(False)
...
process.analyzeHiMassTau.RemoveBJetOverlapWithTaus            = cms.bool(False)                               # if true, jets w/ dR(tau,jet)<X will not be considered
...
process.analyzeHiMassTau.DoSUSYDiscrByDphi2 = cms.bool(True)
process.analyzeHiMassTau.Dphi2MinCut = cms.double(0.5)                                                      # |dphi2| >= X
process.analyzeHiMassTau.Dphi2MaxCut = cms.double(9999.5)                                                   # |dphi2| <= X
