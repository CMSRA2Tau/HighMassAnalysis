...
process.analyzeHiMassTau.RecoMuon2TrackIsoSumPtMaxCutValue = cms.double(0.1)
...
process.analyzeHiMassTau.DoRecoMuon2DiscrByNormalizedChi2 = cms.bool(True)
...
process.analyzeHiMassTau.RemoveJetOverlapWithMuon2s           = cms.bool(True)
process.analyzeHiMassTau.JetMuon2MatchingDeltaR               = cms.double(0.4)
...
process.analyzeHiMassTau.FirstLeadingJetMuon2MatchingDeltaR               = cms.double(0.4)
...
process.analyzeHiMassTau.SecondLeadingJetMuon2MatchingDeltaR               = cms.double(0.4)
...
process.analyzeHiMassTau.BJetMuon2MatchingDeltaR               = cms.double(0.4)
...
process.analyzeHiMassTau.DoSUSYDiscrByLeadDiJetMass = cms.bool(True)
...
process.analyzeHiMassTau.DoSUSYDiscrByLeadDiJetDeltaEta = cms.bool(True)
...
process.analyzeHiMassTau.DiMuonDiscrByOSLSType = cms.string('OS')
