...
#'/store/user/lpctau/HighMassTau/gurrola/gurrola/mSUGRA_m0-220to3000_m12-100to1000_tanb-40andA0-m500_7TeV-Pythia6Z/mSUGRAPat/a193fc0d1bfb597014de1c843803f6bb/skimPat_1_1_xgn.root', 
'file:skimPat.root'
)
)
...
process.analyzeHiMassTau.RecoTau1PtMinCut = cms.double(25.)					
...
process.analyzeHiMassTau.RecoTau1DiscrByIsolation = cms.untracked.string('byVLooseCombinedIsolationDeltaBetaCorr')	
...
process.analyzeHiMassTau.RecoTau1IsoDeltaRCone = cms.double(0.3)	 				
process.analyzeHiMassTau.RecoTau1TrackIsoTrkThreshold = cms.double(1.5) 				
process.analyzeHiMassTau.RecoTau1GammaIsoGamThreshold = cms.double(2.0) 				
process.analyzeHiMassTau.DoRecoTau1DiscrAgainstElectron = cms.bool(True)				
process.analyzeHiMassTau.RecoTau1DiscrAgainstElectron = cms.untracked.string('againstElectronMVA')
process.analyzeHiMassTau.DoRecoTau1DiscrByCrackCut = cms.bool(True)				
...
process.analyzeHiMassTau.RecoTau2DiscrByIsolation = cms.untracked.string('byVLooseIsolation')
...
process.analyzeHiMassTau.RecoTau2IsoDeltaRCone = cms.double(0.3)
process.analyzeHiMassTau.RecoTau2TrackIsoTrkThreshold = cms.double(1.5)
process.analyzeHiMassTau.RecoTau2GammaIsoGamThreshold = cms.double(2.0)
process.analyzeHiMassTau.DoRecoTau2DiscrAgainstElectron = cms.bool(False)
process.analyzeHiMassTau.RecoTau2DiscrAgainstElectron = cms.untracked.string('againstTightElectron')
...
process.analyzeHiMassTau.RecoTau2DiscrAgainstMuon = cms.untracked.string('againstTightMuon')
...
process.analyzeHiMassTau.RecoMuon1PtMinCut = cms.double(20.)					
process.analyzeHiMassTau.RecoMuon1PtMaxCut = cms.double(40.)					
...
process.analyzeHiMassTau.RecoMuon1TrackIsoSumPtMaxCutValue = cms.double(1.0)			
...
process.analyzeHiMassTau.RecoMuon1IsoDeltaRCone = cms.double(0.3)				
process.analyzeHiMassTau.RecoMuon1TrackIsoTrkThreshold = cms.double(1.5)				
process.analyzeHiMassTau.RecoMuon1EcalIsoRecHitThreshold = cms.double(2.0)			
...
process.analyzeHiMassTau.RecoMuon2IsoDeltaRCone = cms.double(0.3)
process.analyzeHiMassTau.RecoMuon2TrackIsoTrkThreshold = cms.double(1.5)
process.analyzeHiMassTau.RecoMuon2EcalIsoRecHitThreshold = cms.double(2.0)
...
process.analyzeHiMassTau.RecoJetEtaMaxCut                    = cms.double(999.5)                      
process.analyzeHiMassTau.RecoJetPtCut                        = cms.double(30.0)                       
process.analyzeHiMassTau.UseCorrectedJet                     = cms.bool(True)                         
process.analyzeHiMassTau.RemoveJetOverlapWithMuon1s           = cms.bool(False)                        
process.analyzeHiMassTau.JetMuon1MatchingDeltaR               = cms.double(0.5)                        
...
process.analyzeHiMassTau.UseTauSeedTrackForDiTauDiscrByOSLS = cms.bool(True) 		
...
process.analyzeHiMassTau.Muon1Tau1DeltaRCut = cms.double(0.7)
process.analyzeHiMassTau.Muon1Tau1DiscrByOSLSType = cms.string('OS')
process.analyzeHiMassTau.UseTauSeedTrackForMuon1Tau1DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForMuon1Tau2DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForMuon2Tau1DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForMuon2Tau2DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForElectron1Tau1DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForElectron1Tau2DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForElectron2Tau1DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.UseTauSeedTrackForElectron2Tau2DiscrByOSLS = cms.bool(True)
...
process.analyzeHiMassTau.DoDiscrByMuon1MetMt = cms.bool(True)
