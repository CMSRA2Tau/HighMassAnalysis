...
process.analyzeHiMassTau.RecoMuon1TrackIsoSumPtMaxCutValue = cms.double(0.2)			
...
process.analyzeHiMassTau.RecoMuon2TrackIsoSumPtMaxCutValue = cms.double(0.2)
...
process.analyzeHiMassTau.DoRecoElectron2DiscrByIsolation = cms.bool(False)
...
process.analyzeHiMassTau.TriggerRequirements = cms.vstring('HLT_DiPFJet40_PFMETnoMu65_MJJ600VBF_LeadingJets_v2')  # trigger path name
...
process.analyzeHiMassTau.RecoMetCut = cms.double(100.0) 					
...
process.analyzeHiMassTau.DoDiJetDiscrByDeltaPhi = cms.bool(True)
...
#process.analyzeHiMassTau.TauDecayModeType = cms.vstring('1')
...
process.analyzeHiMassTau.EventSelectionSequence = cms.vstring('GenTauNmin','GenTauNmax',
                                                              ...
                                                              'DiJetCombinationsNmin','DiJetCombinationsNmax', 'RecoGoodPUjetsNmin', 
                                                              'RecoTriggersNmin',
